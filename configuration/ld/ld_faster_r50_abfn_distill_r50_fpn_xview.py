...
work_dir = './work_dirs/ld/ld_faster_r50_abfn_distill_r50_fpn_xview'
img_scale = (800, 800)
num_classes = 1
num_proposal = 10000
...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_ld=dict(
            type='TwoStageKnowledgeDistillationKLDivLoss',
