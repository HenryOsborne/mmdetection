...
work_dir = './work_dirs/fgd/fgd1_faster_r50_abfn_distill_faster_r34_fpn_xview'
img_scale = (800, 800)
num_classes = 1
num_proposal = 10000
student_cfg = 'configuration/tmp/faster_r34_fpn_xview.py'
...
distiller = dict(
    ...
    teacher_pretrained='work_dirs/exp/faster_r50_abfn_mid_xview/epoch_30.pth',
    init_student=True,
    distill_cfg=[
        dict(
