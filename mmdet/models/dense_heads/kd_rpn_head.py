...
class LDRPNHead(LDAnchorHead):
    ...
    def __init__(
        ...
        super(LDRPNHead, self).__init__(1, in_channels, init_cfg=init_cfg, **kwargs)
    ...
    def loss(
        ...
        """
        losses = super(LDRPNHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
        ...
        return dict(
            ...
            loss_rpn_ld=losses['losses_ld'],
            loss_rpn_kd=losses['losses_kd']
        )
