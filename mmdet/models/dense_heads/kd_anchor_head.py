...
class LDAnchorHead(LDBaseDenseHead, BBoxTestMixin):
    ...
    def __init__(
        ...
        super(LDAnchorHead, self).__init__(init_cfg)
    ...
    def loss_single(self,
        ...
        soft_label_weights = soft_label_weights.reshape(-1)
        ...
        soft_targets = soft_targets.reshape(-1, 4)
        soft_target_weights = soft_target_weights.reshape(-1, 4)
        ...
        return loss_cls, loss_bbox, loss_ld, loss_kd
    ...
    def loss(
        ...
        losses_cls, losses_bbox, losses_ld, losses_kd = multi_apply(
            self.loss_single,
            cls_scores,
            bbox_preds,
            all_anchor_list,
        ...
        return dict(loss_cls=losses_cls, loss_bbox=losses_bbox, losses_ld=losses_ld, losses_kd=losses_kd)
