...
class FGFI_RPNHead(FGFI_AnchorHead):
    """RPN head.
    ...
    def __init__(
        ...
        super(FGFI_RPNHead, self).__init__(
    ...
    def loss(
        ...
        """
        losses, mask_batch = super(FGFI_RPNHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
        ...
        return dict(loss_rpn_cls=losses['loss_cls'], loss_rpn_bbox=losses['loss_bbox']), mask_batch
    ...
    def onnx_export(self, x, img_metas):
        ...
        batch_bboxes, batch_scores = super(FGFI_RPNHead, self).onnx_export(
