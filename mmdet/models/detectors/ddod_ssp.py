...
class SingleStageDetector(BaseDetector):
    ...
    def forward_train(self,
        ...
        bbox_loss = self.bbox_head.forward_train(x, img_metas, gt_bboxes,
...
class DDODSPP(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(DDODSPP, self).__init__(backbone, neck, bbox_head, train_cfg,
