...
class FGDNonlocalLoss(nn.Module):
    ...
    def __init__(
        ...
        super(FGDNonlocalLoss, self).__init__()
        self.temp = temp
        ...
        self.stu_non_local = NonLocalBlockND(256, inter_channels=64, downsample_stride=8)
        self.teac_non_local = NonLocalBlockND(256, inter_channels=64, downsample_stride=8)
        # ============================================================================
    ...
    def get_rela_loss(self, preds_S, preds_T):
        ...
        out_s = self.stu_non_local(preds_S)
        out_t = self.teac_non_local(preds_T)
