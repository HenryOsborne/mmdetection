...
class FeatureLoss4(nn.Module):
    ...
    def __init__(self,
        ...
        super(FeatureLoss4, self).__init__()
        self.temp = temp
    ...
    def forward(self,
        ...
        dis_loss = self.get_dis_loss(preds_stu, preds_teac)
        loss = self.alpha_fgd * fg_loss + self.beta_fgd * bg_loss + self.gamma_fgd * mask_loss + self.alpha_mgd * dis_loss
        # ======================================================================================
        return loss
