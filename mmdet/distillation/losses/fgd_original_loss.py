...
class FGDOriginalLoss(nn.Module):
    ...
    def __init__(self,
        ...
        super(FGDOriginalLoss, self).__init__()
        self.temp = temp
    ...
    def forward(self,
        ...
        fg_loss, bg_loss = self.get_fea_loss(preds_S, preds_T, Mask_fg, Mask_bg, C_attention_s, C_attention_t,
