...
class FGD_Ori_BG_Loss(nn.Module):
    ...
    def __init__(
        ...
        super(FGD_Ori_BG_Loss, self).__init__()
        self.temp = temp
    ...
    def forward(self,
        ...
        Mask_fg = torch.zeros_like(teac_spatial_attention)
        Mask_bg = torch.ones_like(teac_spatial_attention)
        wmin, wmax, hmin, hmax = [], [], [], []
        for i in range(N):
