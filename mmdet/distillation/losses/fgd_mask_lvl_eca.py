...
class FeatureLoss6(nn.Module):
    ...
    def __init__(self,
        ...
        super(FeatureLoss6, self).__init__()
        self.temp = temp
        ...
        # ============================================================================
        self.teac_rela_att = ECABasicBlock(256, 256)
        self.stu_rela_att = ECABasicBlock(256, 256)
        # ============================================================================
    ...
    def get_rela_loss(self, preds_S, preds_T):
        ...
        out_s = self.stu_rela_att(preds_S)
        out_t = self.teac_rela_att(preds_T)
