...
class FGDGlobalLoss(nn.Module):
    ...
    def __init__(
        ...
        super(FGDGlobalLoss, self).__init__()
        self.temp = temp
    ...
    def forward(self,
        ...
        # self.alpha_fgd * fg_loss + self.beta_fgd * bg_loss + self.gamma_fgd * mask_loss + self.lambda_fgd * rela_loss
        return loss
