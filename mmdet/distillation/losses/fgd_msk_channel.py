...
from mmdet.utils.fca_layer import MultiSpectralAttentionLayer
...
class FeatureLoss5(nn.Module):
    ...
    def __init__(self,
        ...
        super(FeatureLoss5, self).__init__()
        self.temp = temp
        ...
        self.stu_channel_att = MultiSpectralAttentionLayer(256, c2wh[256], c2wh[256], reduction=16,
                                                           freq_sel_method='top16')
        self.teac_channel_att = MultiSpectralAttentionLayer(256, c2wh[256], c2wh[256], reduction=16,
                                                            freq_sel_method='top16')
        # ============================================================================
    ...
    def forward(self,
        ...
        mask_loss = self.get_mask_loss(
            ...
            stu_spatial_attention,
            teac_spatial_attention)
        rela_loss = self.get_rela_att_loss(preds_stu, preds_teac)
    ...
    def get_rela_att_loss(self, preds_S, preds_T):
        loss_mse = nn.MSELoss(reduction='sum')

        out_s = self.stu_channel_att(preds_S)
        out_t = self.teac_channel_att(preds_T)
